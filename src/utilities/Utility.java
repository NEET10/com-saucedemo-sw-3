...
public class Utility extends BaseTest {
    ...
    public void clearTextAndSendKey(By by, String text){
        Actions actions = new Actions(driver);
        WebElement quantity = driver.findElement(by);
        quantity.clear();
        WebElement emailField = driver.findElement(by);
    ...
    public void mouseHoverToElementToAnotherElement(By by, By by1){
        Actions actions = new Actions(driver);
        actions.moveToElement(driver.findElement(by)).moveToElement(driver.findElement(by1)).build().perform();
    }
    public void mouseHoverToElementToAnotherElementAndClick(By by, By by1){
        Actions actions = new Actions(driver);
